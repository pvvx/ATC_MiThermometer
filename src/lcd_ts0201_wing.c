...
#if DEVICE_TYPE == DEVICE_TS0201_WING
#include "drivers.h"
...
/*
 *  TS0201_TZ3000_dnpd6ayp, TZ-Z3TH13 LCD buffer:  byte.bit
 *  The ZY-ZTH02Pro/ZY-ZTH03Pro has a similar LCD.
