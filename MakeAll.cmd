...
@del /Q "TS0201S%SWVER%.bin"
make -s -j PROJECT_NAME=TS0201S%SWVER% POJECT_DEF="-DDEVICE_TYPE=DEVICE_TS0201 -DUSE_SENSOR_MY18B20=1"
@if not exist "TS0201S%SWVER%.bin" goto :error
