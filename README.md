...
2. UUID 0x181A - size 19: custom - temperature x0.01C, humidity x0.01%, battery voltage in mV, battery charge level 0..100%, GPIO-pin flags (mark “reset”) and triggers.
